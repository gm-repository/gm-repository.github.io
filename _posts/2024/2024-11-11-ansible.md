...
- [Introdução ao Ansible e à Automação de Infraestrutura](#seção-1-introdução-ao-ansible-e-à-automação-de-infraestrutura)
- [Instalação e Configuração do Ansible](#seção-2-instalação-e-configuração-do-ansible)
- [Configuração de Inventário no Ansible](#seção-3-configuração-de-inventário-no-ansible)
- [Introdução aos Playbooks do Ansible](#seção-4-introdução-aos-playbooks-do-ansible)
- [Uso de Módulos no Ansible para Tarefas Comuns](#seção-5-uso-de-módulos-no-ansible-para-tarefas-comuns)
- [Variáveis e Filtros no Ansible](#seção-6-variáveis-e-filtros-no-ansible)
- [Loops e Condicionais em Playbooks](#seção-7-loops-e-condicionais-em-playbooks)
- [Handlers e Notificações no Ansible](#seção-8-handlers-e-notificações-no-ansible)
- [Roles: Estrutura Modular para Playbooks](#seção-9-roles-estrutura-modular-para-playbooks)
- [Gerenciamento de Secrets e Vault do Ansible](#seção-10-gerenciamento-de-secrets-e-vault-do-ansible)
- [Debugging e Testes de Playbooks](#seção-11-debugging-e-testes-de-playbooks)
- [Implementação de Pipelines CI/CD com Ansible](#seção-12-implementação-de-pipelines-cicd-com-ansible)
- [Configuração de Infraestrutura com Ansible e Cloud Providers](#seção-13-configuração-de-infraestrutura-com-ansible-e-cloud-providers)
- [Monitoramento e Log de Execuções do Ansible](#seção-14-monitoramento-e-log-de-execuções-do-ansible)
- [Práticas Recomendadas e Boas Práticas com Ansible](#seção-15-práticas-recomendadas-e-boas-práticas-com-ansible)
...
- name: Configuração do Servidor Web com Variáveis e Filtros
  ...
  vars:
    apache_package: apache2
    welcome_message: "Bem-vindo ao {{ environment | default('desenvolvimento') }}"
